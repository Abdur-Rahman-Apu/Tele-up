            ...
            <form onSubmit={handleSearch}>
                <div className="flex justify-center my-10">
                    ...
                    <div className="relative w-80">
                        ...
                        <button type="submit" className="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-[#0A72BA] rounded-r-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
